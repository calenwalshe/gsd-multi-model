...
@/home/agent/.claude/get-shit-done/references/ui-brand.md
</required_reading>
...
**If found:**
1. Read template: `/home/agent/.claude/get-shit-done/templates/VALIDATION.md`
...
Route to `<offer_next>` to present next steps to the user.
