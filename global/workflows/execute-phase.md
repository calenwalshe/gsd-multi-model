...
2. **Spawn executor agents:**
   ...
   Task(
     ...
     prompt="
       ...
       @/home/agent/.claude/get-shit-done/references/checkpoints.md
       @/home/agent/.claude/get-shit-done/references/tdd.md
       </execution_context>
...
<!-- auto-mode checkpoint handling removed in v2.0 -- use /gsd:drive for auto-chaining -->
...
<!-- auto_advance removed in v2.0 -- use /gsd:drive for auto-chaining -->

The workflow ends. The user runs `/gsd:progress` or invokes the transition workflow manually. For automated chaining, use `/gsd:drive`.
</step>
