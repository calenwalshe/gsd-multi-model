...
Continue: /gsd:plan-phase [X+1]
Or use /gsd:drive for automated chaining.
```
...
Continue: /gsd:discuss-phase [X+1]
Or use /gsd:drive for automated chaining.
```
...
<!-- _auto_chain_active config-set removed in v2.0 -- use /gsd:drive for auto-chaining -->
